<?php
    ...
    $email="lic.juanpablocesarini@gmail.com";
    $pass ="geuzukkmibknfsxs";
    $from_name ="CLOUDSTOCK";
    $host = "smtp.gmail.com";
    $port = 465;
    $smtp_auth=true;
    $smtp_secure=  'ssl';
    ...
    $body = "<p>Hola
            <br>
            Tu nueva contraseña para utilizar CLOUDSTOCK: tu inventario es:<br> <b>{$new_pass}</b><br>
